...
class StrategyInfo(genpy.Message):
  _md5sum = "97fdcf0f263b5f43bee35f3f082e9188"
...
float32 y
"""
  __slots__ = ['header','AgentID','role','action','is_dribble','is_kickoff','role_time','pass_cmd']
  _slot_types = ['std_msgs/Header','int32','uint32','uint32','bool','bool','float32','nubot_common/PassCommands']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,AgentID,role,action,is_dribble,is_kickoff,role_time,pass_cmd
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.AgentID, _x.role, _x.action, _x.is_dribble, _x.is_kickoff, _x.role_time, _x.pass_cmd.pass_id, _x.pass_cmd.catch_id, _x.pass_cmd.pass_pt.x, _x.pass_cmd.pass_pt.y, _x.pass_cmd.catch_pt.x, _x.pass_cmd.catch_pt.y, _x.pass_cmd.is_passout, _x.pass_cmd.is_dynamic_pass, _x.pass_cmd.is_static_pass, _x.pass_cmd.is_valid,) = _get_struct_i2I2Bf2I4f4B().unpack(str[start:end])
...
def _get_struct_3I():
    ...
    return _struct_3I
_struct_i2I2Bf2I4f4B = None
def _get_struct_i2I2Bf2I4f4B():
    global _struct_i2I2Bf2I4f4B
    if _struct_i2I2Bf2I4f4B is None:
        _struct_i2I2Bf2I4f4B = struct.Struct("<i2I2Bf2I4f4B")
    return _struct_i2I2Bf2I4f4B
