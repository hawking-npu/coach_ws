...
class simulation_strategy(genpy.Message):
  _md5sum = "940eb7237544dce342214714d52a48c0"
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.strategy_msgs:
        ...
        _x = val1
        buff.write(_get_struct_i2I2Bf().pack(_x.AgentID, _x.role, _x.action, _x.is_dribble, _x.is_kickoff, _x.role_time))
        _v3 = val1.pass_cmd
        _x = _v3
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        (_x.AgentID, _x.role, _x.action, _x.is_dribble, _x.is_kickoff, _x.role_time,) = _get_struct_i2I2Bf().unpack(str[start:end])
...
def _get_struct_I():
    ...
    return _struct_I
_struct_i2I2Bf = None
def _get_struct_i2I2Bf():
    global _struct_i2I2Bf
    if _struct_i2I2Bf is None:
        _struct_i2I2Bf = struct.Struct("<i2I2Bf")
    return _struct_i2I2Bf
_struct_4B = None
def _get_struct_4B():
    global _struct_4B
